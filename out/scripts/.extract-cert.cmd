cmd_scripts/extract-cert := gcc -Wp,-MD,scripts/.extract-cert.d -Iscripts -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89  -I../tools/include -o scripts/extract-cert ../scripts/extract-cert.c  -lcrypto
